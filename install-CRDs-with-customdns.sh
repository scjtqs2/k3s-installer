...
helm repo update
helm upgrade --install   cert-manager jetstack/cert-manager   --namespace cert-manager   --create-namespace   --version v1.19.1   --set installCRDs=true --set prometheus.enabled=false \
